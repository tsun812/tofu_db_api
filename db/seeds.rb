...
application2 = user1.applications.create! ({primary_field: "Building Name", secondary_field: "Price", background_color: 13, description: "This is a building app", font: 14, display_theme: "Card", img_url: "https://luxurylaunches.com/wp-content/uploads/2021/09/1000-year-old-castle-on-sale-6.jpg", app_name: "Real Estate Directory"})
...
value32 = record2.values.create!({field_value: "/images/vancouverMansion.png", field: field16})
value33 = record3.values.create!({field_value: "/images/calgaryApartment.png", field: field16})
value34 = record6.values.create!({field_value: "/images/torontoBasement.png", field: field16})
...
value66 = record10.values.create!({field_value: "/images/seaweedHouse.png", field: field16})
...
value94 = record15.values.create!({field_value: "/images/londonHouse.png", field: field16})
