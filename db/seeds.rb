...
application1 = user1.applications.create! ({primary_field: "Word", secondary_field: "Part of Speech", background_color: "black", description: "This is a fruit dictionary app", font: 12, display_theme: "List", img_url: "https://images.unsplash.com/photo-1491841651911-c44c30c34548?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8b2xkJTIwYm9va3N8ZW58MHx8MHx8&w=1000&q=80", app_name: "Fruit Dictionary"})
application2 = user1.applications.create! ({primary_field: "Building Name", secondary_field: "Price", background_color: "green", description: "This is a building app", font: 14, display_theme: "Grid", img_url: "https://luxurylaunches.com/wp-content/uploads/2021/09/1000-year-old-castle-on-sale-6.jpg", app_name: "Real Estate Directory"})
...
value4 = record4.values.create!({field_value: "North-west India", field: field2 })
...
value7 = record5.values.create!({field_value: "Fragaria", field: field3 })
value8 = record4.values.create!({field_value: "Citrus", field: field3})
value9 = record1.values.create!({field_value: "Ananas", field: field3})
value10 = record1.values.create!({field_value: "Red", field: field4})
value49 = record4.values.create!({field_value: "Yellow", field: field4})
value50 = record5.values.create!({field_value: "PineappleColor", field: field4})
value51 = record1.values.create!({field_value: 3, field: field5})
value52 = record4.values.create!({field_value: 5, field: field5})
value53 = record5.values.create!({field_value: 7, field: field5})
...
value56 = record9.values.create!({field_value: "Citrus", field: field3})
value57 = record9.values.create!({field_value: "Lime", field: field4})
value58 = record9.values.create!({field_value: 1, field: field5})
...
value27 = record3.values.create!({field_value: "Not Available", field: field14})
